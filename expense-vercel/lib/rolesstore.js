...
// Google Sheet. Finance assigns roles from the User Access page; this applies them on top of the
// config defaults so dashboard access + approval routing follow the assignment with no redeploy.
// Keys: ceo (single email), finance (comma-separated emails), dept:<DeptName> (single head email).
...
// Snapshot for the User Access UI: current effective assignments + the department list.
