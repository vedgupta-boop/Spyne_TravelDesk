...
// Uploads (receipts / invoices) go to a Drive folder shared (Editor) with the service account.
...
export async function uploadToDrive({ filename, mimeType, base64 }) {
  ...
  // Restrict viewing to the company domain only — a leaked link is useless to outsiders.
