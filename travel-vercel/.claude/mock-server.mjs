...
const APPROVALS = { scope: 'Technology', rows: [
  ...
  { id: 'TRF-20260901-AB12', name: 'Priya Sharma', email: 'priya@spyne.ai', dept: 'Technology', type: 'international', trip: 'Round trip',
    ...
    recallable: true, recallFrom: 'Admin (booking)', recallTo: 'HOD',
...
const FOREX = { rows: [
  { id: 'TRF-20260901-AB12', date: '17 Jun 2026', name: 'Ved Prakash', email: 'ved.gupta@spyne.ai', dept: 'Technology',
    ...
    done: false, recallable: true, forexBase: 500, topups: [], forexTotal: 500 },
  { id: 'TRF-20261101-EX22', date: '16 Jul 2026', name: 'Meera Iyer', email: 'meera.iyer@spyne.ai', dept: 'Product',
    to: 'Dubai', purpose: 'Client Meeting', start: '01 Nov 2026', days: 4, nationality: 'India', passportNo: 'P4455667',
    passportIssue: '10 Feb 2022, Mumbai', designation: 'Product Manager', address: '9 Hill Road, Mumbai 400050', mobile: '+91 98111 22334',
    forex: 500, ticketInfo: 'EK501, 01 Nov 2026, PNR DXB123', docPassport: '#doc', docVisa: '#doc', docPanAadhaar: '',
    idDocType: 'Aadhaar & PAN (India)', docAadhaar: '#doc', docPan: '#doc', docNationalId: '', docTicket: '#doc',
    docForexConfirm: '', status: 'Booking done — Forex card (Jasvinder)',
    currency: 'USD', total: 2200, trip: 'Round trip', route: 'Mumbai → Dubai',
    flag: 'Within policy', breakdown: { transport: 700, mode: 'Flight (Economy)', local: 250, hotel: 500, hotelRate: 125, hotelNights: 4, meals: 280, mealRate: 70, other: 0, forex: 500, days: 4, nights: 4 },
    done: false, recallable: true, existingCard: true, forexBase: 500, topups: [], forexTotal: 500 },
...
http.createServer((req, res) => {
  ...
  if (url === '/api/finance' && /view=currency-audit/.test(qs)) return json(res, { ok: true, audit: [
    ...
    { id: 'TRF-20260713-DPZZ', name: 'Vanshit Kothari', route: 'Gurugram (DEL) → Miami (MIA)', status: 'Pending CEO Approval' },
  ] });
