...
// Uploads go to a Drive folder shared (Editor) with the service account.
...
export async function uploadToDrive({ filename, mimeType, base64 }) {
  ...
  // account can open the doc, but a leaked link is useless to outsiders. (Was "anyone with link".)
