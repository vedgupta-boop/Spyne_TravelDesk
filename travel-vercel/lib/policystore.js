...
export const EDITABLE = [
  ...
  { path: 'POLICY.CAPS.FLIGHT.domestic', label: 'Flight cap — domestic (₹)', group: 'Budget caps (reference only)' },
  { path: 'POLICY.CAPS.FLIGHT.us_domestic', label: 'Flight cap — US domestic ($)', group: 'Budget caps (reference only)' },
  { path: 'POLICY.CAPS.FLIGHT.international', label: 'Flight cap — international ($)', group: 'Budget caps (reference only)' },
  { path: 'POLICY.CAPS.TOTAL.domestic', label: 'Total cap — domestic (₹)', group: 'Budget caps (reference only)' },
  { path: 'POLICY.CAPS.TOTAL.international', label: 'Total cap — international ($)', group: 'Budget caps (reference only)' },
